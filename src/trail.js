...
class ApiTable extends PureComponent {
  ...
  handleValidateUpload = () =>{
    ...
    if(TotallenOfObj == lenOfArr && lenOfObj ==4){
      ...
      this.setState({validate:'Invalid data'})
    }
  }
      ...
      < >
        ...
        <Grid container justify="center" alignItems="center">
          ...
          {/* <Grid item md={4} sm={4} xs={11}> */}
            {/* <Button variant="contained" onClick={this.handleFile} style={{background:"#fe7a51",color:"#fff"}}>
              Upload
            </Button> */}

            <Button variant="contained" onClick={this.handleValidateUpload} style={{background:"#fe7a51",color:"#fff"}}>
              Upload
            </Button>
   {this.state.validate}
          </Grid>
